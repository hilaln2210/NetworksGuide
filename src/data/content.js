...
export const tracks = [
  {
    ...
    chapters: [
      { id: 100, title: "מה זה אבטחת מידע? — מבוא מאפס",  pages: [{ type: "html_page", title: "מבוא מאפס",                        src: "/learn/security/learn_ch01.html" }] },
      { id: 101, title: "יסודות אבטחת מידע — CIA Triad",   pages: [{ type: "html_page", title: "יסודות אבטחת מידע — CIA Triad",   src: "/learn/security/learn_ch02.html", srcEn: "/learn/security-en/learn_ch01.html" }] },
      { id: 102, title: "Social Engineering & Phishing",    pages: [{ type: "html_page", title: "Social Engineering & Phishing",    src: "/learn/security/learn_ch03.html", srcEn: "/learn/security-en/learn_ch02.html" }] },
      { id: 103, title: "קריפטוגרפיה — ההצפנה שמגנה על הכל", pages: [{ type: "html_page", title: "Cryptography",                  src: "/learn/security/learn_ch04.html", srcEn: "/learn/security-en/learn_ch03.html" }] },
      { id: 104, title: "אבטחת רשת — Firewalls, IDS, VPN", pages: [{ type: "html_page", title: "Network Security",                  src: "/learn/security/learn_ch05.html", srcEn: "/learn/security-en/learn_ch04.html" }] },
      { id: 105, title: "Malware — סוגים, זיהוי ומניעה",   pages: [{ type: "html_page", title: "Malware",                           src: "/learn/security/learn_ch06.html", srcEn: "/learn/security-en/learn_ch05.html" }] },
      { id: 106, title: "Penetration Testing — לחשוב כמו תוקף", pages: [{ type: "html_page", title: "Penetration Testing",        src: "/learn/security/learn_ch07.html", srcEn: "/learn/security-en/learn_ch06.html" }] },
      { id: 107, title: "SOC & Incident Response",          pages: [{ type: "html_page", title: "SOC & Incident Response",          src: "/learn/security/learn_ch08.html", srcEn: "/learn/security-en/learn_ch07.html" }] },
      { id: 108, title: "Cloud Security & Compliance",      pages: [{ type: "html_page", title: "Cloud Security & Compliance",      src: "/learn/security/learn_ch09.html", srcEn: "/learn/security-en/learn_ch08.html" }] }
    ]
  },
  {
    id: 'devops',
...
// Backward compatibility — defaults to cyber track chapters
