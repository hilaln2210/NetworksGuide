...
export const tracks = [
  ...
  },
  {
    id: 'crypto',
    title: 'קריפטוגרפיה',
    subtitle: 'AES, TLS, Blockchain, Wallets, Scam Detection, Red Team — 10 פרקים + 6 מעבדות. סגנון TryHackMe.',
    icon: '🔐',
    color: '#f0b90b',
    level: 'מתחיל–מתקדם',
    quizSrc: '/learn/crypto/quiz_game.html',
    chapters: [
      { id: 500, title: "🔑 יסודות — Encryption vs Hashing vs Encoding", pages: [{ type: "html_page", title: "Foundations",               src: "/learn/crypto/learn_ch01.html", srcEn: "/learn/crypto-en/learn_ch01.html" }] },
      { id: 501, title: "🔐 אלגוריתמים — AES, RSA, SHA-256",            pages: [{ type: "html_page", title: "Crypto Algorithms",         src: "/learn/crypto/learn_ch02.html", srcEn: "/learn/crypto-en/learn_ch02.html" }] },
      { id: 502, title: "🌐 Crypto בעולם האמיתי — TLS, JWT",             pages: [{ type: "html_page", title: "Real World Crypto",         src: "/learn/crypto/learn_ch03.html", srcEn: "/learn/crypto-en/learn_ch03.html" }] },
      { id: 503, title: "🧱 Blockchain ומערכות קריפטו",                   pages: [{ type: "html_page", title: "Blockchain",               src: "/learn/crypto/learn_ch04.html", srcEn: "/learn/crypto-en/learn_ch04.html" }] },
      { id: 504, title: "👛 ארנקים דיגיטליים",                            pages: [{ type: "html_page", title: "Wallets",                  src: "/learn/crypto/learn_ch05.html", srcEn: "/learn/crypto-en/learn_ch05.html" }] },
      { id: 505, title: "🌍 Wallet Intelligence — מודיעין ארנקים",        pages: [{ type: "html_page", title: "Wallet Intelligence",      src: "/learn/crypto/learn_ch06.html", srcEn: "/learn/crypto-en/learn_ch06.html" }] },
      { id: 506, title: "🚨 זיהוי Scams — Rug Pulls, Phishing",          pages: [{ type: "html_page", title: "Scam Detection",           src: "/learn/crypto/learn_ch07.html", srcEn: "/learn/crypto-en/learn_ch07.html" }] },
      { id: 507, title: "🔴 התקפות קריפטו — Red Team",                   pages: [{ type: "html_page", title: "Crypto Attacks",           src: "/learn/crypto/learn_ch08.html", srcEn: "/learn/crypto-en/learn_ch08.html" }] },
      { id: 508, title: "🛠️ כלים — Wireshark, Hashcat, CyberChef",       pages: [{ type: "html_page", title: "Tools",                    src: "/learn/crypto/learn_ch09.html", srcEn: "/learn/crypto-en/learn_ch09.html" }] },
      { id: 509, title: "🧪 מעבדה סופית — Final Challenge",              pages: [{ type: "html_page", title: "Final Challenge",          src: "/learn/crypto/learn_ch10.html", srcEn: "/learn/crypto-en/learn_ch10.html" }] },
    ]
  },
  // ── LOCKED — בעריכה ──
  {
