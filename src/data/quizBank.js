...
export const quizBank = {
  ...
  4: [
    ...
    },
    {
      ...
      explanation: "\u200F🎯 קודי תגובה — קל לזכור לפי קבוצות:\n\n✅ 2xx = הצלחה\n👈 200 = הכל תקין\n\n↪️ 3xx = הפניה\n👈 301 = הפניה קבועה\n\n❌ 4xx = שגיאת לקוח\n👈 404 = לא נמצא\n👈 403 = אסור\n\n💥 5xx = שגיאת שרת\n👈 500 = שגיאה פנימית"
    },
    {
      q: "\u200Fמהו פרוטוקול SMTP?",
    ...
    },
    {
      ...
      correct: "\u200Fגרסה 2 תומכת בריבוב (כמה בקשות בחיבור אחד) 🚀\nגרסה 1.1 מטפלת בבקשה אחת בכל פעם",
      choices: [
        "\u200Fגרסה 2 תומכת בריבוב (כמה בקשות בחיבור אחד) 🚀\nגרסה 1.1 מטפלת בבקשה אחת בכל פעם",
    ...
    },
    {
      ...
      correct: "\u200F301 = הפניה קבועה ♾️ (הדפדפן שומר)\n302 = הפניה זמנית ⏱️ (לא נשמרת)",
      choices: [
        "\u200F301 = הפניה קבועה ♾️ (הדפדפן שומר)\n302 = הפניה זמנית ⏱️ (לא נשמרת)",
