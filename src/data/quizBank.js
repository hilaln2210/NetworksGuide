  ...
  4: [
    {
      ...
      correct: "\u200Fפרוטוקול להעברת דפי אינטרנט, פועל בשכבת האפליקציה",
      choices: [
        "\u200Fפרוטוקול להעברת דפי אינטרנט, פועל בשכבת האפליקציה",
        "\u200Fפרוטוקול להצפנת תקשורת, פועל בשכבת התעבורה",
        "\u200Fפרוטוקול לניהול כתובות IP, פועל בשכבת הרשת",
        "\u200Fפרוטוקול להעברת קבצים, פועל בשכבת הקו"
      ],
      explanation: "\u200FHTTP (פרוטוקול העברת היפרטקסט) — כשאת פותחת אתר, הדפדפן שולח בקשת GET ומקבל בחזרה דף HTML. זה הבסיס של כל גלישה באינטרנט ✨"
    },
    {
      q: "\u200Fמה ההבדל בין בקשת GET לבקשת POST?",
      correct: "\u200FGET מביאה מידע מהשרת, POST שולחת מידע לשרת",
      choices: [
        "\u200FGET מביאה מידע מהשרת, POST שולחת מידע לשרת",
        "\u200FGET מוצפנת, POST לא מוצפנת",
        "\u200FGET לדפדפן בלבד, POST לאפליקציות מובייל",
        "\u200FGET תמיד מהירה יותר, POST אמינה יותר"
      ],
      explanation: "\u200FGET = 'תני לי את הדף'. POST = 'הנה הנתונים שמילאתי בטופס'. כשאת נרשמת לאתר — זו בקשת POST עם שם משתמש וסיסמה 📝"
    },
    {
      q: "\u200Fמה אומר קוד תגובה 404?",
      correct: "\u200Fהדף או המשאב המבוקש לא נמצא בשרת",
      choices: [
        "\u200Fהדף או המשאב המבוקש לא נמצא בשרת",
        "\u200Fשגיאה פנימית בשרת",
        "\u200Fהבקשה הצליחה",
        "\u200Fהגישה אסורה (חסרה הרשאה)"
      ],
      explanation: "\u200Fקודי תגובה: 2xx = הצלחה ✅ | 3xx = הפניה | 4xx = שגיאת לקוח (404 = לא נמצא, 403 = אסור) | 5xx = שגיאת שרת. הקוד המפורסם ביותר: 200 = הכל תקין! 🎯"
    },
    {
      q: "\u200Fמהו פרוטוקול SMTP?",
      ...
      explanation: "\u200FSMTP (פרוטוקול שליחת דואר פשוט) — פועל על פורט 25 או 587. כשאת שולחת מייל מג'ימייל, הוא עובר דרך שרת SMTP. לקבלת מייל יש פרוטוקולים נפרדים: POP3 ו-IMAP 📧"
    },
    {
      q: "\u200Fמה ההבדל בין גרסה 1.1 לגרסה 2 של HTTP?",
      correct: "\u200Fגרסה 2 תומכת בריבוב (מספר בקשות בחיבור אחד), דחיסת כותרות ודחיפת תוכן מהשרת. גרסה 1.1 מטפלת בבקשה אחת בכל פעם",
      choices: [
        "\u200Fגרסה 2 תומכת בריבוב (מספר בקשות בחיבור אחד), דחיסת כותרות ודחיפת תוכן מהשרת. גרסה 1.1 מטפלת בבקשה אחת בכל פעם",
        "\u200Fגרסה 2 פועלת על UDP, גרסה 1.1 על TCP",
        "\u200Fההבדל רק במהירות — גרסה 2 מהירה יותר",
        "\u200Fגרסה 2 דורשת הצפנה, גרסה 1.1 לא"
      ],
      explanation: "\u200Fגרסה 1.1: כל משאב דורש חיבור TCP חדש (מקסימום 6 חיבורים לדומיין). גרסה 2: מסגור בינארי וריבוב (Multiplexing) — עשרות זרמים בחיבור אחד. דחיסת כותרות (HPACK) חוסכת רוחב פס. דחיפת שרת (Server Push): השרת שולח קבצי CSS ו-JS לפני שביקשו אותם."
    },
    {
      q: "\u200Fמה ההבדל בין קוד 301 לקוד 302?",
      correct: "\u200F301 = הפניה קבועה (הדפדפן והמטמון שומרים). 302 = הפניה זמנית (לא נשמרת במטמון)",
      choices: [
        "\u200F301 = הפניה קבועה (הדפדפן והמטמון שומרים). 302 = הפניה זמנית (לא נשמרת במטמון)",
        "\u200F301 = שגיאת שרת, 302 = שגיאת לקוח",
        "\u200Fשניהם זהים — רק שמות שונים",
        "\u200F301 = הפניה ל-HTTPS, 302 = הפניה ל-HTTP"
      ],
      explanation: "\u200Fקודי תגובה לפי קבוצות: 1xx = מידע, 2xx = הצלחה (200 תקין, 201 נוצר), 3xx = הפניה (301 קבועה, 302 זמנית, 304 לא השתנה), 4xx = שגיאת לקוח (400 בקשה שגויה, 401 לא מאומת, 403 אסור, 404 לא נמצא), 5xx = שגיאת שרת (500 שגיאה פנימית, 503 לא זמין). לגבי SEO: גוגל מעביר דירוג דרך 301, לא דרך 302."
    },
  ],
